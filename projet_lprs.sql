...
`ref_etudiant` int(11) NOT NULL,
PRIMARYKEY(`ref_evenement`,`ref_etudiant`)
)ENGINE=InnoDBDEFAULTCHARSET=latin1;
...
`ref_offre` int(11) NOT NULL,
`ref_entreprise` int(11) NOT NULL,
PRIMARYKEY(`ref_offre`,`ref_entreprise`)
)ENGINE=InnoDBDEFAULTCHARSET=latin1;
...
`ref_offre` int(11) NOT NULL,
`ref_etudiant` int(11) NOT NULL,
PRIMARYKEY(`ref_offre`,`ref_etudiant`)
)ENGINE=InnoDBDEFAULTCHARSET=latin1;
...
PRIMARYKEY(`ref_rdv`,`ref_entreprise`)
)ENGINE=InnoDBDEFAULTCHARSET=latin1;
...
ADD CONSTRAINT `fkorganise_rdv` FOREIGN KEY(`ref_rdv`) REFERENCES `rdv` (`id_rdv`),
