...
if (isset($_POST['enregistrer'])){
    ...
    if ($organiser) echo '<script>alert("Evénement enregistrer")</script>';
...
<head>
    ...
    <title>Organiser un événement &mdash; LPRS</title>
...
<div id="page">
    ...
    <aside id="fh5co-hero">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image: url(../../style/images/img_bg_6.jpg);">
                    <div class="overlay-gradient"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center slider-text">
                                <div class="slider-text-inner">
                                    <h1 class="heading-section">Organiser un événement</h1>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <h3 class="text-center">Organiser un événement</h3>
                    <form action='' method='POST'>

                        <div class='row form-group'>
                            <div class="col-md-12">
                                <input type='text' class='form-control' placeholder="Nom de l'événement" name='nom'  required>
                            </div>
                        </div>
