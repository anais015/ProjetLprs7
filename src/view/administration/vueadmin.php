...
if(isset($_SESSION['id_admin'])){
    $page="Bienvenue ".$_SESSION['nom_admin'];
}else{
...
<body>
    ...
    <div id="page">
        ...
        <div style="height: 29.7vh; width: 50%; display: flex; flex-direction: column; justify-content: space-around;margin: auto;text-align: center;">
            <?=$page;?><br>
            <a style="color: inherit" href="attributionsalle.php"><button class="btn-primary">Attribution de salle en attente (<?=$countpe?>)</button></a><br>
            <a style="color: inherit" href="validationcompte.php"><button class="btn-primary">Validation des compte en attente (<?=$countpa?>)</button></a><br>
            <a style="color: inherit" href="gestiontypeoffre.php"><button class="btn-primary">Gestion des type d'offre</button></a><br>
            <a style="color: inherit" href="gestionsalle.php"><button class="btn-primary">Gestion des salles</button></a>
        </div>
